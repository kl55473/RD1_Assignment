...
<select id="city" name="city" size="1">
    ...
    <input class="button1" type="submit" name="nowcity" value="確認" onclick="location.href='index.php'">
    </div>
    <?php }else{
    ...
    ?>
        ...
        <input class="button" type="button" name="twocity" value="未來兩天天氣" onclick="location.href='weather.php?ind=2'">
        <input class="button" type="button" name="weekcity" value="一週天氣" onclick="location.href='weather.php?ind=3'">
